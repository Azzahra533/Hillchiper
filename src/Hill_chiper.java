        ...
        try {
            ...
            if(scan.hasNextLine()){
                ...
                if(ProcessType.ENKRIPSI.equals(processType)) {
                    ...
                    File writer = new File("D:\\Enkripsi.txt");
                    ...
                    e.printStackTrace();
                     ...
                     System.out.println("\nHASIL ENKRIPSI DISIMPAN KE : \"D://Dekripsi.txt\"");
            ...
            System.out.println("FILE TIDAK DITEMUKAN DI \"D://Dekripsi.txt\" / KESALAHAN DALAM MENGISI!");     }               
    }
